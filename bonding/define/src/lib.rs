...
pub extern "C" fn bonding_ext() {
    ...
    let bond_amount: U512 = contract_api::get_arg(0);
...
pub extern "C" fn call() {
    ...
    let pointer = contract_api::store_function("bonding_ext", named_keys);
    contract_api::add_uref("bonding", &pointer.into())
}
